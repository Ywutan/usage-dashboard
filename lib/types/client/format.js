 ...
 */
export function formatPeriod(range) {
 ...
 */
export function formatEventTime(epochMs) {
 ...
 */
export function compactJson(value, maxChars = 200) {
    let text;
 ...
 */
export function eventSummary(type, data, labels) {
